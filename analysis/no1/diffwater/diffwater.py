...
mar, borderless_markers, size, centroids = difference_algo_water(img, kernel=kernel,
interval=interval, blocksize=blocksize, start=start, end=end, iteration=iteration, 
inverse=inverse, removal=removal)
